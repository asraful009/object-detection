...
class BusinessCardGenerator:
    def __init__(self, height = 320, ):
        ...
        self.__card_location = ((0, 0), (640, 640))
        self.__rotation_val = random.randint(0, 359)

    def generate(self, person_info: PersonInfo, rotation_val = 0)-> "BusinessCardGenerator":
        self.__person_info = person_info
        self.__rotation_val = rotation_val
        rgb = (
            tuple(
    ...
    def __draw_background(self):
        ...
        # print(rotation_val)
        rotated_image_expanded = self.__image_rotation(self.__rotation_val)
        ...
        self.__card_location = ((pl, pt), (pl+w, pt+h))
